...
export default {
  ...
  forgotPassword: {
    ...
    phonePlaceholder: "Ex: 36000000",
    submitButton: "Envoyer le code",
    backToLogin: "Retour à la connexion",
    successMessage: "Si un compte existe, vous recevrez un SMS avec le code de vérification.",
    phoneRequired: "Veuillez entrer votre numéro de téléphone.",
    phoneInvalid: "Numéro invalide — doit commencer par 2, 3 ou 4 et contenir 8 chiffres.",
  },
  resetPassword: {
    title: "Réinitialiser le mot de passe",
    otpLabel: "Code de vérification (OTP)",
    otpPlaceholder: "Ex: 123456",
    passwordLabel: "Nouveau mot de passe",
    confirmPasswordLabel: "Confirmer le mot de passe",
    submitButton: "Réinitialiser",
    successMessage: "Mot de passe réinitialisé avec succès !",
    otpRequired: "Veuillez entrer le code OTP reçu par SMS.",
